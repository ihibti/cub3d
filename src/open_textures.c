...
/*   Updated: 2024/09/25 14:34:11 by gchenot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	open_textures_no(t_ori *ori)
{
	...
	else
	{
		...
		// brexit(ori);
		brexit(ori, ERROR_NTEXTURE, NULL);
	}
	return (0);
}
...
int	open_textures_so(t_ori *ori)
{
	...
	else
	{
		...
		// brexit(ori);
		brexit(ori, ERROR_STEXTURE, NULL);
	}
	return (0);
}
...
int	open_textures_ea(t_ori *ori)
{
	...
	else
	{
		...
		// brexit(ori);
		brexit(ori, ERROR_ETEXTURE, NULL);
	}
	return (0);
}
...
int	open_textures_we(t_ori *ori)
{
	...
	else
	{
		...
		// brexit(ori);
		brexit(ori, ERROR_WTEXTURE, NULL);
	}
	return (0);
}
